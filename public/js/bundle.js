 ...
 */
                      ...
                      while (1)
                        switch ((_context.prev = _context.next)) {
                          case 0:
                            ...
                            url =
                              type === 'password'
                                ? 'http://127.0.0.1:800/api/v1/users/updateMyPassword'
                                : 'http://127.0.0.1:800/api/v1/users/updateMe';
                            _context.next = 4;
                            return (0, _axios.default)({
                              method: 'PATCH',
                              url: url,
                      ...
                      try {
                        window.setTimeout(function () {
                          ...
                          window.location.href =
                            'http://127.0.0.1:800/search-person?firstName='.concat(
                              name,
                            );
                        }, 500);
                        // // }
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        if (foundPersonForm)
          foundPersonForm.addEventListener('submit', function (e) {
            e.preventDefault();
            ...
            form.append(
              'approxAge',
              document.getElementById('approxAge').value,
            );
            form.append(
              'UniqueIdentifier',
        ...
        if (searchForm)
          searchForm.addEventListener('submit', function (e) {
            ...
            if (name)
              window.location.href =
                'http://127.0.0.1:800/search-person?firstName='.concat(name);
        ...
        if (filterForm)
          filterForm.addEventListener('change', function (e) {
            ...
            if (sort)
              window.location.href =
                'http://127.0.0.1:800/search-person?sort='.concat(sort);
            else if (country)
              window.location.href =
                'http://127.0.0.1:800/search-person?country='.concat(country);
            else if (gender)
              window.location.href =
                'http://127.0.0.1:800/search-person?gender='.concat(gender);
            // ! APPROXIMATE-AGE FILTER
              ...
              window.location.href =
                'http://127.0.0.1:800/search-person?approxAge[gte]='
                  .concat(minAge, '&approxAge[lte]=')
                  .concat(maxAge);
            } else window.location.href = 'http://127.0.0.1:800/search-person';
          });
        ...
        if (btnNext) {
          btnNext.addEventListener('click', function (e) {
            ...
            window.location.href =
              'http://127.0.0.1:800/search-person?page='.concat(page);
          });
        }
        if (btnPrev)
      ...
      },
      {
        ...
        './foundPersonForm': 'foundPersonForm.js',
        './searchPerson': 'searchPerson.js',
      },
    ],
