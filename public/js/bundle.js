...
document.querySelectorAll('.update-button').forEach(function (button) {
  button.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
      var personId, response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            personId = event.target.getAttribute('data-id');
            _context2.prev = 1;
            _context2.next = 4;
            return axios.get("/update-person/".concat(personId));
          case 4:
            ...
            document.getElementById('updateForm').addEventListener('submit', /*#__PURE__*/function () {
                  ...
                  while (1) switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      updatedDetails = {
                        ...
                        clothingDescription: document.getElementById('clothingDescription').value,
                      ...
                      _context.prev = 2;
                      _context.next = 5;
                      return axios.patch("/api/persons/".concat(personId), updatedDetails);
                    case 5:
                    ...
                    case 8:
                      ...
                      console.error('Error updating person:', _context.t0);
                    case 11:
                    case "end":
                      return _context.stop();
                  }
          ...
          case 9:
            ...
            console.error('Error fetching update form:', _context2.t0);
          case 12:
          case "end":
            return _context2.stop();
        }
