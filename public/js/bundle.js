...
if (foundPersonForm) foundPersonForm.addEventListener('submit', function (e) {
  ...
  form.append('firstName', document.getElementById('firstName').value.toLowerCase());
  form.append('lastName', document.getElementById('lastName').value.toLowerCase());
...
if (searchForm) searchForm.addEventListener('submit', function (e) {
  ...
  // searchPerson(name);
  if (name) window.location.href = "http://127.0.0.1:800/search-person?firstName=".concat(name);else window.location.href = "http://127.0.0.1:800/search-person";
});
