...
if (searchForm) searchForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('search-person-name').value;

  // searchPerson(name);
  if (name) window.location.href = "http://127.0.0.1:800/search-person?name=".concat(name);else window.location.href = "http://127.0.0.1:800/search-person";
});
